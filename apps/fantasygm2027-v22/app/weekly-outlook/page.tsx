...
import WeeklyHitters from '../shared/weekly-hitters';
...
export default function WeeklyOutlook() {
  ...
  return <main className="dcc"><header className="dcc-masthead"><div><p>FANTASYGM2027 / DESERT RATS</p><h1>Weekly Outlook — Hitters</h1></div><a href="/" style={{display:"inline-block",padding:"6px 10px",border:"1px solid #377960",borderRadius:6,color:"#b7f8df",background:"#193329",fontSize:13,fontWeight:600,textDecoration:"none",whiteSpace:"nowrap"}}>Back to Home</a><button onClick={refresh} disabled={busy}>{busy?'Refreshing…':'Refresh'}</button></header><section id="office-0"><WeeklyHitters current={current} failed={failed}/></section></main>;
}
